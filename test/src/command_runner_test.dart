...
import 'package:widgetbook_coverage_cli/src/command_runner.dart';
...
void main() {
  group('WidgetbookCoverageCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late WidgetbookCoverageCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = WidgetbookCoverageCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = WidgetbookCoverageCliCommandRunner();
